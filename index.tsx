...
const TrophyIcon = () => (
  <svg viewBox="0 0 24 24" className="w-8 h-8 text-yellow-600">
    <path
      d="M6 9V2h12v7c0 3-2.69 6-6 6s-6-3-6-6z M6 9H2v3c0 1.66 1.34 3 3 3h1 M18 9h4v3c0 1.66-1.34 3-3 3h-1 M12 18v4 M8 22h8"
      stroke="currentColor"
      fill="none"
      strokeWidth="2"
      strokeLinecap="round"
      ...
      <div className="bg-white p-8 rounded-lg max-w-md relative">
        ...
        <div className="text-center">
          <div className={`inline-block ${
            ...
            robotSpeed === 2 ? 'animate-[bounce_0.5s_infinite]' : 
            'animate-[bounce_0.3s_infinite]'
          }`}>
            <RobotIcon />
          </div>
